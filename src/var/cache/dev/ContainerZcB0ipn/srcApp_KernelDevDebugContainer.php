...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            ...
            'old_sound_rabbit_mq.emailing_consumer' => 'getOldSoundRabbitMq_EmailingConsumerService',
            'old_sound_rabbit_mq.emailing_producer' => 'getOldSoundRabbitMq_EmailingProducerService',
    ...
    protected function getOldSoundRabbitMq_Connection_DefaultService()
    {
        ...
        return $this->services['old_sound_rabbit_mq.connection.default'] = (new \OldSound\RabbitMqBundle\RabbitMq\AMQPConnectionFactory('PhpAmqpLib\\Connection\\AMQPConnection', ['url' => $this->getEnv('RABBITMQ_URL'), 'host' => 'rabbitmq', 'user' => 'rabbitmq', 'password' => 'rabbitmq', 'vhost' => '/', 'port' => 5672, 'lazy' => false, 'connection_timeout' => 3, 'read_write_timeout' => 3, 'use_socket' => false, 'ssl_context' => [], 'keepalive' => false, 'heartbeat' => 0]))->createConnection();
    }

    /**
     * Gets the public 'old_sound_rabbit_mq.emailing_consumer' shared service.
     *
     * @return \OldSound\RabbitMqBundle\RabbitMq\Consumer
     */
    protected function getOldSoundRabbitMq_EmailingConsumerService()
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Rabbit/EmailService.php';

        $this->services['old_sound_rabbit_mq.emailing_consumer'] = $instance = new \OldSound\RabbitMqBundle\RabbitMq\Consumer(($this->services['old_sound_rabbit_mq.connection.default'] ?? $this->getOldSoundRabbitMq_Connection_DefaultService()));

        $instance->setExchangeOptions(['name' => 'user_queue', 'type' => 'direct', 'passive' => false, 'durable' => true, 'auto_delete' => false, 'internal' => false, 'nowait' => false, 'declare' => true, 'arguments' => NULL, 'ticket' => NULL]);
        $instance->setQueueOptions(['name' => 'user_queue', 'passive' => false, 'durable' => true, 'exclusive' => false, 'auto_delete' => false, 'nowait' => false, 'declare' => true, 'arguments' => NULL, 'ticket' => NULL, 'routing_keys' => []]);
        $instance->setCallback([0 => new \App\Rabbit\EmailService(), 1 => 'execute']);
    ...
    /**
     * Gets the public 'old_sound_rabbit_mq.emailing_producer' shared service.
     *
     * @return \OldSound\RabbitMqBundle\RabbitMq\Producer
     */
    protected function getOldSoundRabbitMq_EmailingProducerService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/php-amqplib/rabbitmq-bundle/RabbitMq/BaseAmqp.php';
        ...
        $this->services['old_sound_rabbit_mq.emailing_producer'] = $instance = new \OldSound\RabbitMqBundle\RabbitMq\Producer(($this->services['old_sound_rabbit_mq.connection.default'] ?? $this->getOldSoundRabbitMq_Connection_DefaultService()));
    ...
    protected function getOldSoundRabbitMq_PartsHolderService()
    {
        ...
        $a = ($this->services['old_sound_rabbit_mq.emailing_producer'] ?? $this->getOldSoundRabbitMq_EmailingProducerService());
        $b = ($this->services['old_sound_rabbit_mq.emailing_consumer'] ?? $this->getOldSoundRabbitMq_EmailingConsumerService());
